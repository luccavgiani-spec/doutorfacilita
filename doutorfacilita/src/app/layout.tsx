  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&family=Caveat:wght@700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>{children}</body>
