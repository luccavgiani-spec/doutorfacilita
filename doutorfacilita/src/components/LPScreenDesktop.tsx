    ...
    <div className="lp-d">
        ...
        <div className="lp-d-section-inner">
          ...
          <div className="lp-d-pricing-grid">
            ...
            <div className="lp-d-price-card">
              ...
              <a href="mailto:suporte@meuplantaodigital.com" className="lp-d-price-cta">Falar com vendas</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="lp-d-footer">
        <div className="lp-d-footer-inner">
          ...
          <div className="lp-d-footer-col">
            <h5>Suporte</h5>
            <a href="mailto:suporte@meuplantaodigital.com">suporte@meuplantaodigital.com</a>
