...
/**
 * Consulta desktop (≥1024px). Vídeo fullscreen estilo Meet/Zoom.
 * Estilos com prefixo `cm-d-*` em globals.css (Seção 5).
 */
export default function ConsultaScreenDesktop() {
  return (
    <div className="cm-d">
      <header className="cm-d-topbar">
        <div className="cm-d-topbar-left">
          <div className="logo-no" style={{ color: "white" }}>
            <span className="dots"><span></span><span></span><span></span><span></span></span>
            <span className="no-word" style={{ color: "#8ab4f8" }}>nó</span>
          </div>
          <div className="cm-d-doctor-meta">
            <div className="cm-d-doctor-name">Dr. Carlos Mendes</div>
            <div className="cm-d-doctor-spec">Clínico Geral · CRM-SP 345678</div>
          </div>
        </div>

        <div className="cm-d-topbar-center">
          <div className="cm-d-live-pill">
            <span className="ld"></span>
            AO VIVO
          </div>
          <div className="cm-d-timer">06:42</div>
        </div>

        <div className="cm-d-topbar-right">
          <button className="cm-d-topbar-btn" aria-label="Mensagens">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            <span className="cm-d-topbar-badge">1</span>
          </button>
          <button className="cm-d-topbar-btn" aria-label="Configurações">
      ...
      <main className="cm-d-stage">
        <div className="cm-d-doctor-tile">
          <div className="cm-d-doctor-av">CM</div>
          <div className="cm-d-doctor-card">
            <div className="cm-d-doctor-card-name">Dr. Carlos Mendes</div>
            <div className="cm-d-doctor-card-spec">Clínico Geral</div>
            <div className="cm-d-doctor-card-crm">CRM-SP 345678</div>
          </div>
        </div>

        <div className="cm-d-pip">
          <div className="cm-d-pip-placeholder">
          ...
          <div className="cm-d-pip-label">Você</div>
        </div>

        <div className="cm-d-banner">
          ...
          <div className="cm-d-banner-text">
            <b>Receita recebida</b>
            <span>chegou no seu SMS há 1 min</span>
          </div>
          <button className="cm-d-banner-btn">Ver receita</button>
        </div>

        <div className="cm-d-controls">
          <button className="cm-d-ctrl" aria-label="Microfone">
          ...
          <button className="cm-d-ctrl" aria-label="Câmera">
          ...
          <Link href="/" className="cm-d-ctrl end" aria-label="Encerrar">
          ...
          <button className="cm-d-ctrl" aria-label="Compartilhar tela">
          ...
          <button className="cm-d-ctrl" aria-label="Configurações">
